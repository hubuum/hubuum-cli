...
| --- | --- | --- | --- |
| Unreleased | 0.9.0 | 0.0.9 | Current development target |
| 0.0.8 | 0.8.0 | 0.0.8 | Current published target |
...
The v0.0.9 development target is tested by `hubuum_client` against the
immutable Hubuum server v0.0.9 image
