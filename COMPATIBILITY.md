...
| --- | --- | --- | --- |
| Unreleased | 0.8.0 | 0.0.8 | Current development target |
| 0.0.5 | 0.7.2 | 0.0.5 | Current published target |
...
The current development target is tested by `hubuum_client` against the immutable
