...
mod tests {
    ...
    fn command_catalog_only_exposes_allowed_id_options() {
        ...
        let allowed = [
            ...
            "bg show --id",
            "bg watch --task",
            "class schema cancel --task",
            "class schema generate-report --task",
            "class schema report --task",
            "class schema work --task",
            ...
            "service-account token renew --token-id",
    ...
    fn existing_entity_reference_options_have_dynamic_completion() {
        ...
        for (path, option_name) in [
            ...
            (&["group", "add_service_account"][..], "--groupname"),
            (&["group", "add_service_account"][..], "--name"),
            (&["group", "remove_service_account"][..], "--groupname"),
            (&["group", "remove_service_account"][..], "--name"),
